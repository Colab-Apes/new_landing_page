...
const HowItWorks = () => {
  return (
    <div>
      {" "}
      <div className=" py-40 mt-36 z-10 container mx-auto px-32 relative">
        <div className="absolute -z-10 blur-[300px] right-[-20rem] w-[387px] h-[410.85px] bg-[#C26AAA] rounded-[410.85px]"></div>
        <div className="absolute -z-10 blur-[300px] bottom-[-10rem] left-[-20rem] w-[387px] h-[410.85px] bg-[#C26AAA] rounded-[410.85px]"></div>
        <div className="w-full text-center text-5xl text-[#333] font-bold mb-36">
          How It Works
        </div>
        <div className="   flex flex-col mt-20  md:flex-row gap-x-[8rem] justify-between items-start mb-10">
          ...
          <div className="flex  items-start gap-x-20 rounded-[20px] pb-20  shadow-[5px_10px_30px_0px_rgba(59,_128,_4,_0.10)] bg-[#ECF8EE] py-10 px-10 w-full">
