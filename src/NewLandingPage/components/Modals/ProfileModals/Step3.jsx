        ...
        <div className="flex flex-col px-4 lg:px-10   gap-y-4 w-full justify-evenly items-center lg:items-start  h-full lg:justify-normal mt-14 lg:mt-0    sm:w-[19rem] lg:w-full lg:h-full md:w-full md:h-full ">
          ...
          <div className="flex items-center">
            <div className="flex flex-col items-center mt-4">
              ...
              <div className="text-[#555]  text-xl mt-2">Bio</div>
            </div>
            ...
            <div className="flex flex-col items-center mt-4">
              ...
              <div className="text-[#555] text-xl mt-2">Profession</div>
            </div>
            <div className="h-[0.2rem] w-[10rem] bg-[#999]"></div>
            <div className="flex flex-col items-center mt-4">
          ...
          <form
            action="
      "
            className="w-full gap-y-4 flex flex-col items-center"
          >
            <div className="w-full">
              <label htmlFor="interest" className="block font-bold text-xl">
                Interest
              </label>
              <select
                name=""
