...
const Signup = ({
  ...
  return (
    <div
      className={
        opensignupmodalprop
          ? " rounded-[20px] lg:rounded-[3.13rem] z-[120]   bg-[#F5FFF7] flex items-center justify-between min-h-[63rem] r  w-full py-0  sm:pb-0 md:py-4      sm:min-h-[35rem] lg:min-h-[32rem] lg:w-full  xl:min-h-[54rem] xl:h-[] lg:p-[3rem]  xl:w-full  md:w-ful sm:px-8 md:px-[3rem] xl:px-[3.5rem] opacity-100 xl:py-[3.5rem]  relative duration-[800ms] ease-in-out"
          : "hidden"
      }
    >
      ...
      >
        ...
        <div className="w-full h-full lg:block  hidden  lg:rounded-[1.56rem] ">
          <img src={img1} alt="" className="lg:rounded-[1.56rem] object-cover" />
        </div>
        <div className="flex flex-col  w-full justify-evenly h-full lg:justify-normal   items-center  sm:w-[19rem] lg:w-full lg:h-full md:w-full md:h-full ">
          ...
          >
            ...
            <div className="relative   md:mt-0 lg:mt-4">
              ...
              <label htmlFor="password" className="text-[#333] block font-bold text-xl">
                Create password
              </label>
              <input
