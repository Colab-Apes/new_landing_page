  ...
  return (
    <div>
      <div className="relative mt-64 lg:mt-36 px-4 lg:px-20  mx-auto">
        ...
        <div className=" flex flex-col justify-start md:justify-center items-center mt-20 bg-transparent   h-[80%] lg:w-[80%] mx-auto rounded-2xl  p-0 md:p-14 xl:p-0">
          <h1 className="text-[#054E12] text-center text-3xl lg:text-[24px]  ">
            Stay connected and informed: <br />
            Join our newsletter for the latest successful projects and business
            deals.
          </h1>
          <form className="border-2 border-solid py-2 relative border-[#3B8004] gap-10 flex  mt-20 items-center p-3 xl:0  rounded-[10px] lg:rounded-[20px] w-full">
