      ...
      <div className=" grid lg:grid-cols-2 mt-32 gap-x-20 gap-y-10">
        <div className="flex flex-col w-full text-[#999] gap-y-4">
          ...
          <select
            name=""
            id=""
            className="focus:outline-none text-[#333] bg-[#fff]/[20%] py-4   border-2 rounded-[10px] text-[16px] font-bold  border-[#999]/[0.5]"
          >
          ...
          <div className="bg-[#F8F8F8] gap-[20px] flex flex-col  rounded-[10px] p-[20px]">
            ...
            <input
              ...
              // value={email}
              className="text-[16px] bg-transparent  w-full md:w-[40rem] lg:w-full p-0 outline-none border-2 rounded-[10px] border-[#999]/[0.5] placeholder:font-bold placeholder:text-[#333] h-[50px]  pl-4 "
              placeholder="$ 10,0000"
            />
          </div>
        </div>
