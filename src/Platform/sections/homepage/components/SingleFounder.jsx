...
const SingleFounder = ({ creator, opendetails }) => {
  return (
    <div
      className={
        opendetails
          ? "absolute hidden lg:flex top-56 rounded-[20px] right-16 shadow-[15px_15px_50px_0px_rgba(5,_78,_18,_0.10)] px-10 pb-8 min-h-[280px] w-[242px] z-10 bg-[#fff]  flex-col gap-y-2"
          : "hidden"
      }
    >
      <img
